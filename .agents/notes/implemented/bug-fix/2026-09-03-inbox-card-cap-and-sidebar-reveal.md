...
- Revealing unfolds the group transiently; the persisted expansion record, the expand-all list, and the branch state are untouched, so a fold the user made survives opening a session inside it ([fold persistence](2026-09-18-workspace-fold-persistence.md)).
