...
- Desktop `.questionPanel` opens upward from the control column's bottom edge and caps its height to the available transcript area. The [phone layout](2026-09-06-phone-four-entry-navigation.md) places history between the phone header and navigation with a scrolling list and an explicit close action.
