...
export interface RpcErrorDetailsMap {
  ...
  'workspace-membership-invalid': { workspaceId: string; sessionIds: SessionId[]; member: boolean }
  ...
  'directory-invalid': { path: string; reason: 'not-absolute' | 'unavailable' | 'not-directory' }
