...
export interface RpcMethodMap {
  ...
  'session.searchQuestions': SessionsApi['searchQuestions']
  ...
  'session.directories': SessionsApi['directories']
  'session.replaceDirectories': SessionsApi['replaceDirectories']
  ...
  'workspace.setSessionMembership': WorkspaceApi['setSessionMembership']
  'workspace.archiveSession': WorkspaceApi['archiveSession']
  'workspace.archiveSessions': WorkspaceApi['archiveSessions']
