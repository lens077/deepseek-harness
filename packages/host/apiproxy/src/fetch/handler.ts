...
import {
  ...
  sessionDirectoriesRequestSchema,
...
import {
  ...
  workspaceArchiveSessionsRequestSchema,
  ...
  workspaceSetSessionMembershipRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'session.directories': { schema: sessionDirectoriesRequestSchema, invoke: (api, r) => api.sessions.directories(r) },
  'session.replaceDirectories': { schema: sessionReplaceDirectoriesRequestSchema, invoke: (api, r) => api.sessions.replaceDirectories(r) },
  ...
  'workspace.setSessionMembership': { schema: workspaceSetSessionMembershipRequestSchema, invoke: (api, r) => api.workspace.setSessionMembership(r) },
  'workspace.archiveSession': { schema: workspaceArchiveSessionRequestSchema, invoke: (api, r) => api.workspace.archiveSession(r) },
  'workspace.archiveSessions': { schema: workspaceArchiveSessionsRequestSchema, invoke: (api, r) => api.workspace.archiveSessions(r) },
