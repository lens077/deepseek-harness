...
import {
  ...
  sessionReplaceDirectoriesValueSchema,
  sessionSearchQuestionsValueSchema,
...
import {
  ...
  workspaceArchiveSessionsValueSchema,
  ...
  workspaceSetSessionMembershipValueSchema,
...
export interface IApiClient {
  sessions: {
    ...
    searchQuestions(payload: RequestPayload<'session.searchQuestions'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'session.searchQuestions'>>>
    ...
    directories(payload: RequestPayload<'session.directories'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'session.directories'>>>
    replaceDirectories(payload: RequestPayload<'session.replaceDirectories'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'session.replaceDirectories'>>>
  ...
  workspace: {
    ...
    setSessionMembership(payload: RequestPayload<'workspace.setSessionMembership'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'workspace.setSessionMembership'>>>
    ...
    archiveSessions(payload: RequestPayload<'workspace.archiveSessions'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'workspace.archiveSessions'>>>
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'session.searchQuestions': sessionSearchQuestionsValueSchema,
  'session.create': sessionCreateValueSchema,
  'session.history': sessionHistoryValueSchema,
  'session.models': sessionModelsValueSchema,
  'session.selectModel': sessionSelectModelValueSchema,
  'session.rename': sessionRenameValueSchema,
  'session.directories': sessionDirectoriesValueSchema,
  'session.replaceDirectories': sessionReplaceDirectoriesValueSchema,
  ...
  'workspace.setSessionMembership': workspaceSetSessionMembershipValueSchema,
  'workspace.archiveSession': workspaceArchiveSessionValueSchema,
  'workspace.archiveSessions': workspaceArchiveSessionsValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    searchQuestions: (payload, signal) => this.callUnary('session.searchQuestions', payload, signal),
    ...
    directories: (payload, signal) => this.callUnary('session.directories', payload, signal),
    replaceDirectories: (payload, signal) => this.callUnary('session.replaceDirectories', payload, signal),
  ...
  readonly workspace: IApiClient['workspace'] = {
    ...
    setSessionMembership: (payload, signal) => this.callUnary('workspace.setSessionMembership', payload, signal),
    archiveSession: (payload, signal) => this.callUnary('workspace.archiveSession', payload, signal),
    archiveSessions: (payload, signal) => this.callUnary('workspace.archiveSessions', payload, signal),
