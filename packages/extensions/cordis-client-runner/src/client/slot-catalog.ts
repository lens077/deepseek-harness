...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'A resident pane beside the transcript, below the session header and OUTSIDE its scrollport, sized by its own occupant.',
    doc: 'A resident pane beside the transcript, below the session header and\nOUTSIDE its scrollport, sized by its own occupant. Empty by default:\nwith no occupant the transcript fills the session exactly as it does\nwithout this seat.',
    registerOptions: [],
    ownerProps: [
      '/** Header actions derive their state from the standard session/global kit. */\nexport interface ConversationHeaderActionOwnerProps {}',
    ],
