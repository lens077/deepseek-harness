...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    occupants: [
      'client-ui-digest DigestPanel id \'digest\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'center.overlay\', () => ctx.slots.register(\n      { name: \'center.overlay\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-layout/src/client/index.ts:115',
  },
  {
    key: 'companion.usage.panel',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Optional usage dialog supplied by the existing accounting UI.',
    doc: 'Optional usage dialog supplied by the existing accounting UI.',
    registerOptions: [],
    ownerProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'sidebar.footer.action\' (client-ui-companion), so it exists while that entry is mounted',
    occupants: [
      'client-ui-chat CompanionUsage',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'companion.usage.panel\', () => ctx.slots.register(\n      { name: \'companion.usage.panel\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-companion/src/client/index.ts:26',
  },
  {
    key: 'conversation',
    kind: 'single',
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, context-removal, manual-compaction, model-retry, steering, system-prompt, tool-call, turn-error, turn-max-tokens, turn-process, turn-tail, unknown, user, workflow-run',
    ...
    occupants: [
      ...
      'client-ui-chat ContextRemovalNodeView key \'context-removal\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-model-selection QuickModelDock id \'model-quick-switch\'',
      'client-ui-task-flow TaskFlowDock id \'task-flow\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-model-routing ModelRoutingChip',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-digest ReadAcknowledgement id \'digest-read\'',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Controls before the Session breadcrumb title, in ascending order.',
    doc: 'Controls before the Session breadcrumb title, in ascending order.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  {
    key: 'conversation.session.rail',
    kind: 'single',
    scope: 'session',
    summary: 'Optional resident rail beside the Session scrollport.',
    doc: 'Optional resident rail beside the Session scrollport.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-session-files SessionFilesRail',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.session.tabs.leading',
    kind: 'list',
    scope: 'session',
    summary: 'Additive controls before the registered View tabs.',
    doc: 'Additive controls before the registered View tabs.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-session-files SessionFilesButton id \'session-files\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.session.tabs.leading\', () => ctx.slots.register(\n      { name: \'conversation.session.tabs.leading\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:148',
  },
  {
    key: 'conversation.session.tabs.trailing',
    kind: 'list',
    scope: 'session',
    summary: 'Additive readings after the registered View tabs, on the same strip.',
    doc: 'Additive readings after the registered View tabs, on the same strip.\nThe phone presentation shows this seat; desktop keeps the strip for tabs\nalone, so an occupant that also has a desktop seat hides itself here\noutside `[data-mobile]`.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.session.tabs.trailing\', () => ctx.slots.register(\n      { name: \'conversation.session.tabs.trailing\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-task-flow TaskFlowView',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-chat PixelStepperRow',
      'client-ui-chat TurnRailLayoutRow id \'turn-rail-layout\'',
      'client-ui-conversation EnterBehaviorRow id \'composer-enter\'',
      'client-ui-conversation ContentWidthRow id \'content-width\'',
      'client-ui-conversation HomeEndCaretRow id \'home-end-caret\'',
      'client-ui-conversation QuestionShortcutRow id \'question-shortcuts\'',
      'client-ui-model-selection QuickSwitchRow id \'model-quick-switch\'',
      'client-ui-permission-presets PermissionRow id \'permission\'',
      'client-ui-task-flow FlowFontSizeRow id \'task-flow-font-size\'',
      'client-ui-task-flow MobileDockRow id \'task-flow-mobile\'',
      'client-ui-task-flow FlowStyleRow',
  ...
  {
    key: 'settings.layout.item',
    kind: 'list',
    scope: 'root',
    summary: 'One preference row inside the Layout section.',
    doc: 'One preference row inside the Layout section. Feature plugins own their\nrow copy, state, and write path; the shell only orders and stacks rows.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [
      ...
      'client-ui-theme PureUiRow id \'pure-ui\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.layout.item\', () => ctx.slots.register(\n      { name: \'settings.layout.item\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-model-routing ModelRoutingRow',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins FileLockCard',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-digest DigestSettingsSection id \'digest\'',
      'client-ui-digest ProjectSettingsSection id \'project-todos\'',
      'client-ui-digest PinsSettingsSection id \'session-pins\'',
      'client-ui-settings-general GeneralSection id \'general\'',
      'client-ui-settings-general LayoutSection id \'layout\'',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Optional actions above desktop Settings and beside phone header Settings.',
    doc: 'Optional actions above desktop Settings and beside phone header Settings.\nPhone occupants receive wide=false and must remain compact.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-companion Companion id \'rest-companion\'',
  ...
  {
    key: 'sidebar.nav.entry',
    kind: 'list',
    scope: 'root',
    summary: 'Navigation entries between New Session and the browsing region: whole surfaces the center column switches to, rather than actions on one session.',
    doc: 'Navigation entries between New Session and the browsing region: whole\nsurfaces the center column switches to, rather than actions on one\nsession. Declared by this package\'s \'sidebar\' entry; each entry renders\none row that reduces to a single icon on the rail, matching the New\nSession control directly above it.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-digest DigestNavEntry id \'digest\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.nav.entry\', () => ctx.slots.register(\n      { name: \'sidebar.nav.entry\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Directory-flow hole for adding a real Workspace from the sidebar.',
    doc: 'Directory-flow hole for adding a real Workspace from the sidebar.',
    registerOptions: [],
    ownerProps: [
      '/**\n * Owner share of the directory-flow holes: the complete conversation between\n * the trigger surface and the picking interaction. The occupant reads `open`\n * to run/render its interaction and reports exactly one outcome per open.\n */\nexport interface DirectoryFlowOwnerProps {\n  /** True while a picking interaction is requested; flipping back to false withdraws the request. */\n  open: boolean\n  /** True while the owner adopts a picked path; occupants disable their commit affordances. */\n  busy: boolean\n  /** Optional flow-specific picker title; browse occupants use their default when absent. */\n  title?: string\n  /** The operator picked a directory (absolute host path); the owner adopts it. */\n  onPicked: (path: string) => void\n  /** The operator dismissed the interaction; the owner just closes the flow. */\n  onCancel: () => void\n  /** The interaction itself failed (chooser missing, listing denied); the owner shows its error surface. */\n  onError: (message: string) => void\n}',
    ],
  ...
  {
    key: 'sidebar.workspaces.sessionDirectoryFlow',
    kind: 'single',
    scope: 'root',
    summary: 'Directory-flow hole for adding a writable root to one existing Session.',
    doc: 'Directory-flow hole for adding a writable root to one existing Session.',
    registerOptions: [],
    ownerProps: [
      '/**\n * Owner share of the directory-flow holes: the complete conversation between\n * the trigger surface and the picking interaction. The occupant reads `open`\n * to run/render its interaction and reports exactly one outcome per open.\n */\nexport interface DirectoryFlowOwnerProps {\n  /** True while a picking interaction is requested; flipping back to false withdraws the request. */\n  open: boolean\n  /** True while the owner adopts a picked path; occupants disable their commit affordances. */\n  busy: boolean\n  /** Optional flow-specific picker title; browse occupants use their default when absent. */\n  title?: string\n  /** The operator picked a directory (absolute host path); the owner adopts it. */\n  onPicked: (path: string) => void\n  /** The operator dismissed the interaction; the owner just closes the flow. */\n  onCancel: () => void\n  /** The interaction itself failed (chooser missing, listing denied); the owner shows its error surface. */\n  onError: (message: string) => void\n}',
    ],
    ...
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.sessionDirectoryFlow\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.sessionDirectoryFlow\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Additive content rendered beneath one Tool call and before its child calls.',
    doc: 'Additive content rendered beneath one Tool call and before its child calls.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [
      'client-ui-session-files DelegationFiles id \'session-files-delegation\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'tool.call.tail\', () => ctx.slots.register(\n      { name: \'tool.call.tail\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-tool/src/client/contract/slots.ts:28',
  },
  {
