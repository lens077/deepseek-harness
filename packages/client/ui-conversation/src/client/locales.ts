...
export const zh = {
  ...
  'pure.showComposer': '展开输入框',
  'pure.hideComposer': '收起输入框',
  'input.expand': '放大输入区',
  'input.collapse': '还原输入区',
  ...
  'settings.homeEnd.title': '其它输入框的 Home / End',
  'settings.homeEnd.description': '对话输入框始终用 Home / End 跳到行首和行尾，按住 Cmd/Ctrl 跳到全文首尾；此处决定搜索框、设置项等其它文本输入框是否相同',
  'settings.homeEnd.on': '移动光标',
  'settings.homeEnd.off': '浏览器默认（滚动页面）',
...
export const en = {
  ...
  'pure.showComposer': 'Show the composer',
  'pure.hideComposer': 'Hide the composer',
  'input.expand': 'Enlarge the draft area',
  'input.collapse': 'Restore the draft area',
  ...
  'settings.homeEnd.title': 'Home / End in other text fields',
  'settings.homeEnd.description': 'The message composer always sends Home / End to the start and end of the line, with Cmd/Ctrl for the whole draft; this decides whether search boxes, settings fields, and other text inputs do the same',
  'settings.homeEnd.on': 'Move the caret',
  'settings.homeEnd.off': 'Browser default (scroll the page)',
