...
export const zh = {
  ...
  'stats.totalDuration': '总耗时 {duration}',
  'stats.llm': 'LLM {duration}',
  'stats.toolCall': '工具调用 {duration}',
  'stats.retries': '重试 {count} 次（等待 {delay}）',
  'stats.toolErrors': '工具错误 {count}',
  'stats.turnErrors': '运行错误 {count}',
  'stats.interruptions': '中断 {count}',
  'stats.blockedTurns': '受阻 {count}',
  'stats.maxTokenTurns': '达到 token 上限 {count}',
...
export const en = {
  ...
  'stats.retries': 'Retries {count} ({delay} waiting)',
  'stats.toolErrors': 'Tool errors {count}',
  'stats.turnErrors': 'Run errors {count}',
  'stats.interruptions': 'Interruptions {count}',
  'stats.blockedTurns': 'Blocked {count}',
  'stats.maxTokenTurns': 'Token-limit stops {count}',
