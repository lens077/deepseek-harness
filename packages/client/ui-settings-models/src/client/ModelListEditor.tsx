...
const INPUT_CHOICES: readonly { value: Exclude<InputChoice, 'custom'>; labelKey: keyof typeof en }[] = [
  { value: 'inherit', labelKey: 'modelInputInherit' },
  { value: 'multimodal', labelKey: 'modelInputMultimodal' },
  { value: 'text', labelKey: 'modelInputText' },
]

/** The reasoning choices in the order the select lists them. */
const REASONING_CHOICES: readonly { value: ReasoningChoice; labelKey: keyof typeof en }[] = [
  { value: 'inherit', labelKey: 'modelReasoningInherit' },
  { value: 'none', labelKey: 'modelReasoningNone' },
  { value: 'levels', labelKey: 'modelReasoningLevels' },
]
