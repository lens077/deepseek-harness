...
/** Session row plus a test-only pending-interaction marker projected through its separate hook. */
export type DigestSessionSummary = SessionSummary & {
...
export const row = (
  id: string,
  over: Partial<DigestSessionSummary> = {},
