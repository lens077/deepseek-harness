...
import {
  CompactionNodeView, ContextMessageNodeView, ContextRemovalNodeView, RetryNodeView, TurnErrorNodeView,
...
export function registerChatNodeRenderers(
  ...
  ctx.slots.inject('conversation.chat.node', () => ctx.slots.register(
    { name: 'conversation.chat.node', key: 'context-removal', locale: NS }, ContextRemovalNodeView))
  ctx.slots.inject('conversation.chat.node', () => ctx.slots.register(
