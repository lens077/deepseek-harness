...
export const en: Record<PluginsSettingsLocaleKey, string> = {
  ...
  fileLockTitle: 'Shared files',
  fileLockDescription: 'What happens when two conversations use the same file at the same time.',
  fileLockReadWait: 'Wait before asking you (seconds)',
  fileLockReadWaitHint: 'When a file is being edited by another conversation, wait this long for it to finish before asking whether to read it anyway or keep waiting.',
  fileLockWriteWait: 'Give up on editing after (minutes)',
  fileLockWriteWaitHint: 'When another conversation is still editing the file after this long, this one stops waiting and tells you which conversation has it.',
  fileLockLeaseTtl: 'Release a stuck file after (minutes)',
  fileLockLeaseTtlHint: 'A conversation normally releases a file when it finishes replying. If it never finishes, the file is freed for others after this long.',
  fileLockDelegated: 'When there is nobody to ask',
  fileLockDelegatedHint: 'Helper agents working in the background cannot ask you. Choose what they do when a file they need is still being edited.',
  fileLockDelegatedInvalid: 'The saved value is not one of these options.',
  fileLockDelegatedWait: 'Wait until it is free',
...
export const zh: Record<PluginsSettingsLocaleKey, string> = {
  ...
  fileLockTitle: '共用文件',
  fileLockDescription: '两个会话同时用到同一个文件时怎么办。',
  fileLockReadWait: '先等多久再问你（秒）',
  fileLockReadWaitHint: '文件正被另一个会话修改时，先等它这么久；还没改完就来问你：是照现在的样子读，还是继续等。',
  fileLockWriteWait: '等多久就放弃修改（分钟）',
  fileLockWriteWaitHint: '另一个会话改了这么久还没改完，这个会话就不再等，并告诉你文件在哪个会话手里。',
  fileLockLeaseTtl: '多久后强制释放文件（分钟）',
  fileLockLeaseTtlHint: '会话通常回复完就会放开文件。万一它一直没回复完，过了这么久也会放开，让别的会话能用。',
  fileLockDelegated: '没人可问的时候',
  fileLockDelegatedHint: '在后台干活的辅助 Agent 没法问你。它要用的文件还在被修改时，选择它怎么做。',
  fileLockDelegatedInvalid: '已保存的值不在这几个选项里。',
  fileLockDelegatedWait: '等到文件空出来',
