 ...
 * names resolve to that content (wide trigger: its own text; rail trigger: header; dialog:
...
function navIcon(id: string) {
  if (id === 'layout') return <IconPanelLeftOutline16 className={css.navIcon} size={16} />
