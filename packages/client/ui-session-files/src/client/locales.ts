...
export const zh = {
  ...
  'settings.layout.nav': '对话布局',
  'settings.visibility.title': '文件',
  'settings.visibility.description': '对话页顶部的「文件」入口与文件面板。隐藏后对话页只保留对话与轨迹，回复里的文件改动卡片不受影响。',
  'settings.visibility.show': '显示',
  'settings.visibility.hide': '隐藏',
...
export const en: Record<SessionFilesKey, string> = {
  ...
  'settings.layout.nav': 'Conversation layout',
  'settings.visibility.title': 'Files',
  'settings.visibility.description': 'The Files control at the top of the conversation and its file panel. Hiding leaves only Chat and Trajectory; the file-change cards inside replies stay.',
  'settings.visibility.show': 'Show',
  'settings.visibility.hide': 'Hide',
