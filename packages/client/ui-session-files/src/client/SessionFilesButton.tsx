 ...
 */
export function SessionFilesButton({ useSession, useChat, useRail, toggle, t }: SessionFilesButtonProps) {
  ...
  const changed = sessionFilesOf({ chat, running, hasMore }).changed.length
