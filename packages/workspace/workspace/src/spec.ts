...
export const workspaceRecord = z.object({
  ...
  nestedUnder: z.record(z.string(), z.string().transform(value => brandString<SessionId>(value))).default({}),
  createdAt: z.string(),
  updatedAt: z.string(),
})
...
const workspacePendingMutation = z.discriminatedUnion('operation', [
  ...
  z.object({
    ...
    sessionIds: z.array(z.string().transform(value => brandString<SessionId>(value))).min(1).refine(
