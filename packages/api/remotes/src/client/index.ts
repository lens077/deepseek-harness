...
export type {
  ...
  RpcRequest, RpcResponse, RpcResult, SessionDirectories, SessionId, SessionModels, SessionQuestionItem, SessionSearchItem,
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, messageFeedbackRemote, projectTodosRemote, sessionInboxRemote, sessionReferencesRemote,
    ]) {
