...
| [`context-remove/`](context-remove/README.md) | Removes selected completed turns from model-visible history on request; the log and transcript keep them | `ctx.contextRemoval` |
