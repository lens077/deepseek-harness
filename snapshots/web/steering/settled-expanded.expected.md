...
- text: "{{clock}} Task flow 1/1 · Elapsed {{duration}} · Latest branch: #1 Interjection Interjection: include the word BANANA in your final reply. Resolved"
...
- button "Open in canvas":
  - img
  - text: Open in canvas
- region "Task flow graph": "#1 Use the ask_user_question tool to ask me exactly one question with id \"checkpoi… Execution {{duration}} · 2 steps Attached to “Use the ask_user_question tool to ask me exactly one question with id \"checkpoi…” ↳ #1 Interjection: include the word BANANA in your final reply."
