...
- button "Open in canvas":
  - img
  - text: Open in canvas
- region "Task flow graph": "#1 Begin your reply with the plain sentence \"Reading the workspace now.\" as text, … Execution {{duration}} · 2 steps Stopped（stopped manually）"
