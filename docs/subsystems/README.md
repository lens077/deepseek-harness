...
| [session-inbox.md](session-inbox.md) | the user's durable seen/handled/snooze/pin marks, the review time, todos, and the `sessionInbox` Remote contract |
| [project-todos.md](project-todos.md) | project-level todo documents scanned from configured roots and registered workspaces, and the `projectTodos` Remote contract |
