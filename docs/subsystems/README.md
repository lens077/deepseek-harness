...
| [session-inbox.md](session-inbox.md) | durable seen, handled, snooze, and pin marks, the review time, todos, and the `sessionInbox` Remote contract |
| [project-todos.md](project-todos.md) | project todo documents scanned from configured roots and registered Workspaces, and the `projectTodos` Remote contract |
