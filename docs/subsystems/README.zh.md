...
| [session-inbox.md](session-inbox.zh.md) | 持久的已读、已处理、延后和置顶标记、查看时间、待办与 `sessionInbox` Remote 契约 |
| [project-todos.md](project-todos.zh.md) | 从配置的根目录与已注册 Workspace 扫描出的项目待办文档，以及 `projectTodos` Remote 契约 |
