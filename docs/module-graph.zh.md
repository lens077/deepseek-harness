...
flowchart TD
  ...
  subgraph group_todo["packages/todo"]
    pkg_project_todos["project-todos"]
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_digest["client-ui-digest"]
    ...
    pkg_client_ui_session_files["client-ui-session-files"]
    ...
    pkg_client_ui_task_flow["client-ui-task-flow"]
  ...
  subgraph group_guard["packages/guard"]
    ...
    pkg_tool_call_file_lock["tool-call-file-lock"]
  ...
  subgraph group_session["packages/session"]
    ...
    pkg_session_digest["session-digest"]
    ...
    pkg_session_inbox["session-inbox"]
  ...
  pkg_session_inbox --> pkg_brand
  pkg_session_inbox --> pkg_invariants
  pkg_session_inbox --> pkg_session
  pkg_session_inbox --> pkg_storage_domain
  pkg_session_inbox --> pkg_typert_protocol
  ...
  pkg_model_router --> pkg_llm
  pkg_model_router --> pkg_session
  pkg_model_router --> pkg_settings
  ...
  pkg_session_digest --> pkg_invariants
  pkg_session_digest --> pkg_llm
  pkg_session_digest --> pkg_session
  pkg_session_digest --> pkg_session_projection
  ...
  pkg_model_router_llm --> pkg_llm
  pkg_model_router_llm --> pkg_model_router
  pkg_model_router_llm --> pkg_timeout
  pkg_model_router_rules --> pkg_llm
  pkg_model_router_rules --> pkg_model_router
  ...
  pkg_project_todos --> pkg_invariants
  pkg_project_todos --> pkg_settings
  pkg_project_todos --> pkg_storage_domain
  pkg_project_todos --> pkg_typert_protocol
  pkg_project_todos --> pkg_workspace
  ...
  pkg_tool_call_file_lock --> pkg_agent
  pkg_tool_call_file_lock --> pkg_fs
  pkg_tool_call_file_lock --> pkg_llm
  pkg_tool_call_file_lock --> pkg_session
  pkg_tool_call_file_lock --> pkg_session_projection
  pkg_tool_call_file_lock --> pkg_session_title
  pkg_tool_call_file_lock --> pkg_settings
  pkg_tool_call_file_lock --> pkg_tools
  pkg_tool_call_file_lock --> pkg_user_questions
  ...
  pkg_context_remove --> pkg_compaction
  pkg_context_remove --> pkg_llm
  pkg_context_remove --> pkg_session
  pkg_context_remove --> pkg_token_meter
  ...
  pkg_api_session_controller --> pkg_context_remove
  ...
  pkg_api_session_controller --> pkg_model_router
  pkg_api_session_controller --> pkg_native_command
  pkg_api_session_controller --> pkg_sandbox_policy
...
| [`client-ui-digest`](../packages/client/ui-digest) | `client` | — |
...
| [`client-ui-session-files`](../packages/client/ui-session-files) | `client` | — |
...
| [`client-ui-task-flow`](../packages/client/ui-task-flow) | `client` | — |
...
| [`session-inbox`](../packages/session/session-inbox) | `session` | [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`storage-domain`](../packages/storage/storage-domain), [`typert-protocol`](../packages/typert/protocol) |
...
| [`model-router`](../packages/llm/model-router) | `llm` | [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`settings`](../packages/settings/settings) |
...
| [`session-digest`](../packages/session/session-digest) | `session` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection) |
...
| [`model-router-llm`](../packages/llm/model-router-llm) | `llm` | [`llm`](../packages/llm/llm), [`model-router`](../packages/llm/model-router), [`timeout`](../packages/util/timeout) |
| [`model-router-rules`](../packages/llm/model-router-rules) | `llm` | [`llm`](../packages/llm/llm), [`model-router`](../packages/llm/model-router) |
...
| [`project-todos`](../packages/todo/project-todos) | `todo` | [`invariants`](../packages/runtime-diagnostics/invariants), [`settings`](../packages/settings/settings), [`storage-domain`](../packages/storage/storage-domain), [`typert-protocol`](../packages/typert/protocol), [`workspace`](../packages/workspace/workspace) |
...
| [`tool-call-file-lock`](../packages/guard/file-lock) | `guard` | [`agent`](../packages/core/agent), [`fs`](../packages/fs/fs), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection), [`session-title`](../packages/session/session-title), [`settings`](../packages/settings/settings), [`tools`](../packages/core/tools), [`user-questions`](../packages/interaction/user-questions) |
...
| [`context-remove`](../packages/compaction/context-remove) | `compaction` | [`compaction`](../packages/compaction/compaction), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`token-meter`](../packages/llm/token-meter) |
...
| [`api-session-controller`](../packages/api/session-controller) | `api` | [`agent`](../packages/core/agent), [`agent-default-model`](../packages/core/agent-default-model), [`agent-presets`](../packages/preset/agent-presets), [`api-gateway`](../packages/api/gateway), [`attachment`](../packages/attachment/attachment), [`client-connection`](../packages/client/connection), [`client-file-upload`](../packages/client/file-upload), [`commands`](../packages/interaction/commands), [`context-remove`](../packages/compaction/context-remove), [`file-reference`](../packages/context/file-reference), [`fs`](../packages/fs/fs), [`jobs`](../packages/jobs/jobs), [`llm`](../packages/llm/llm), [`model-router`](../packages/llm/model-router), [`native-command`](../packages/util/native-command), [`sandbox-policy`](../packages/sandbox/sandbox-policy), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-projection`](../packages/session/session-projection), [`session-projection-cache`](../packages/session/session-projection-cache), [`session-query`](../packages/session-query/session-query), [`session-title`](../packages/session/session-title), [`skill`](../packages/skill/skill), [`subagent`](../packages/subagent/subagent), [`token-meter`](../packages/llm/token-meter), [`typert-protocol`](../packages/typert/protocol), [`typert-registry`](../packages/typert/registry), [`util-time`](../packages/util/time), [`util-values`](../packages/util/values), [`util-workspace-path`](../packages/util/workspace-path), [`workspace`](../packages/workspace/workspace) |
