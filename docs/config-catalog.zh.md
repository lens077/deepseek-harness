...
需要：`agentDefaultModel` · `agents` · `attachments` · `directoryPicker` · `llm` · `sandboxPolicy` · `sessions` · `subagents` · `sessionQuery` · `tools` · `userQuestions` · `workspaceRegistry`
