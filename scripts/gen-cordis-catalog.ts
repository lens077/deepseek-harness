...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  chatFileDiffs: 'client-side slot-contract accessor (ChatFileDiffs) — packages/client/ui-conversation/README.md owns the API',
  chatQuestionIndex: 'client-side slot-contract accessor (ChatQuestionIndex) — packages/client/ui-conversation/README.md owns the API',
  chatReveal: 'client-side slot-contract accessor (ChatReveal) — packages/client/ui-conversation/README.md owns the API',
  sessionTodos: 'client-side slot-contract accessor (SessionTodos) — packages/client/ui-workspace/README.md owns the API',
  documentBadge: 'client-side interface-typed browser seat (DocumentBadge) — packages/client/ui-renderer/README.md owns the API',
