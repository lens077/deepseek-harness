...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  modelRouter: 'llm-streaming.md',
  toolResultPruner: 'compaction.md',
  contextRemoval: 'compaction.md',
  tools: 'tools.md',
  typert: 'typert.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  chatFileDiffs: 'client-side Session file-change provider — packages/client/ui-chat/README.md owns the API',
  chatFileOpener: 'client-side external file opener — packages/client/ui-chat/README.md owns the API',
  chatReveal: 'client-side cross-Session question reveal provider — packages/client/ui-chat/README.md owns the API',
  chatReplyExposure: 'client-side foreground Chat reply observation — packages/client/ui-chat/README.md#reply-exposure owns the API',
  ...
  questionNavigation: 'client-side question-navigation settings provider — packages/client/ui-conversation/README.md owns the API',
  documentBadge: 'client-side browser-title badge provider — packages/client/ui-layout/README.md owns the API',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'project-todos': 'project-todos.md',
  'skills': 'skills.md',
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'sessions/navigated': 'client-face explicit navigation signal — packages/client/runtime/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  InboxTodoId: 'session-inbox.md',
  InboxSessionState: 'session-inbox.md',
  InboxTodoStatus: 'session-inbox.md',
  InboxTodo: 'session-inbox.md',
  InboxSnapshot: 'session-inbox.md',
  InboxMarkSeenRequest: 'session-inbox.md',
  InboxSetHandledRequest: 'session-inbox.md',
  InboxSnoozeRequest: 'session-inbox.md',
  InboxSetPinnedRequest: 'session-inbox.md',
  InboxAddTodoRequest: 'session-inbox.md',
  InboxUpdateTodoRequest: 'session-inbox.md',
  InboxRemoveTodoRequest: 'session-inbox.md',
  InboxTextBlank: 'session-inbox.md',
  InboxTextTooLarge: 'session-inbox.md',
  InboxTodoNotFound: 'session-inbox.md',
  InboxSnoozeInPast: 'session-inbox.md',
  InboxFailure: 'session-inbox.md',
  InboxSuccess: 'session-inbox.md',
  InboxRejected: 'session-inbox.md',
  InboxTodoResult: 'session-inbox.md',
  InboxSnoozeResult: 'session-inbox.md',
  ProjectTodoStatus: 'project-todos.md',
  ProjectTodoItem: 'project-todos.md',
  ProjectTodoFile: 'project-todos.md',
  ProjectTodoSource: 'project-todos.md',
  ProjectTodoProject: 'project-todos.md',
  ProjectTodoWarning: 'project-todos.md',
  ProjectTodosSettings: 'project-todos.md',
  ProjectTodosSnapshot: 'project-todos.md',
  ProjectTodoReadRequest: 'project-todos.md',
  ProjectTodoDocument: 'project-todos.md',
  ProjectTodoNotListed: 'project-todos.md',
  ProjectTodoReadFailed: 'project-todos.md',
  ProjectTodoReadFailure: 'project-todos.md',
  ProjectTodoSuccess: 'project-todos.md',
  ProjectTodoRejected: 'project-todos.md',
  ProjectTodoReadResult: 'project-todos.md',
  ...
  SessionDirectories: 'session.md',
  SessionDirectoriesRequest: 'session.md',
  ...
  SessionRemoveTurnsRequest: 'session.md',
  SessionRemoveTurnsValue: 'session.md',
  SessionId: 'core.md',
  ...
  SessionProjectionBaseline: 'session.md',
  SessionPromptRequest: 'session.md',
  SessionPromptValue: 'session.md',
  SessionQuestionSearchRequest: 'session.md',
  SessionQuestionSearchValue: 'session.md',
  ...
  SessionReplaceDirectoriesRequest: 'session.md',
  ...
  WorkspaceArchiveSessionsRequest: 'workspace.md',
  ...
  WorkspaceSetSessionMembershipRequest: 'workspace.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  RetireSessionsForDelete: 'session deletion retirement capability is owned by packages/workspace/workspace/README.md',
  ...
  ModelRouteInput: 'model routing service input is owned by packages/llm/model-router/src/types.ts',
  ModelRouteDecision: 'model routing service answer is owned by packages/llm/model-router/src/types.ts',
  ManualCompactAgentContext: 'manual compaction service input is owned by packages/compaction/compaction/src/index.ts',
  ContextRemovalAgentContext: 'context removal service input is owned by packages/compaction/context-remove/src/types.ts',
  ContextRemovalResult: 'context removal service answer is owned by packages/compaction/context-remove/src/types.ts',
