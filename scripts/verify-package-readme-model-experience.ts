...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/llm/model-router': { kind: 'indirect', reason: 'The seam proposes a reasoning effort; the consumer applies it and request assembly owns the model-visible request.' },
  'packages/llm/model-router-rules': { kind: 'indirect', reason: 'The provider answers with an effort id; the dsh-model-router consumer applies it and request assembly owns the model-visible request.' },
  ...
  'packages/client/ui-companion': { kind: 'none', reason: 'Browser-only character interaction; no model-facing input or Session mutations.' },
  ...
  'packages/client/ui-session-files': { kind: 'none', reason: 'Browser-side derivation of render intents already in the session log; the file tools own every model-facing effect and dsh-client-ui-deliverables owns the prompt guidance.' },
  ...
  'packages/client/ui-model-routing': { kind: 'indirect', reason: 'The switch writes model-routing.enabled; dsh-model-router and request assembly own every model-visible effect.' },
